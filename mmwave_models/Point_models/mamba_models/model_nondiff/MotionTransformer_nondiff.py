...
class FFN_nondiff(nn.Module):
    ...
    def __init__(self, latent_dim, ffn_dim, dropout, time_embed_dim):
        ...
        self.proj_out = self.proj_out = self.proj_out = nn.Sequential(
...
class TemporalSelfAttention_nondiff(nn.Module):
...
class TemporalDiffusionTransformerDecoderLayer_nondiff(nn.Module):
    ...
    def __init__(self,
        ...
        super().__init__()
        self.sa_block = TemporalSelfAttention_nondiff(
            latent_dim, num_head, dropout, time_embed_dim)
        self.ffn = FFN_nondiff(latent_dim, ffn_dim, dropout, time_embed_dim)
...
class MotionTransformer_nondiff(nn.Module):
    def __init__(self,
                 input_feats,
                 num_frames=240,
                 latent_dim=512,
        ...
        for i in range(num_layers):
            self.temporal_decoder_blocks.append(
                TemporalDiffusionTransformerDecoderLayer_nondiff(
